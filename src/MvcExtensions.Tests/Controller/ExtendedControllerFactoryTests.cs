...
namespace MvcExtensions.Tests
{
    ...
    public class ExtendedControllerFactoryTests
    {
        ...
        {
            container.Setup(a => a.GetService(typeof(ExtendedControllerActionInvoker))).Verifiable();
        ...
        public void ActionInvoker_should_be_mapped_action_invoker_when_controller_is_registered()
        {
            ...
            container.Setup(a => a.GetService(actionInvoker.Object.GetType())).Verifiable();

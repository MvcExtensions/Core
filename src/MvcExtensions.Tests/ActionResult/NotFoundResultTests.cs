...
namespace MvcExtensions.Tests
{
    ...
    public class NotFoundResultTests
    {
        ...
        private readonly NotFoundResult actionResult;
        ...
        [Fact]
        public void ExecuteResult_should_set_response_status_code_to_404()
        {
            ...
            httpContext.VerifySet(c => c.Response.StatusCode = (int)HttpStatusCode.NotFound);
            httpContext.VerifySet(c => c.Response.Status = "404 Page Not Found");
        }
    }
}
...
namespace MvcExtensions
{
    ...
    /// </summary>
    public class PerRequestTasksRegistry : IPerRequestTasksRegistry
    {
        private static readonly IPerRequestTasksRegistry instance = new PerRequestTasksRegistry();
        ...
        public static IPerRequestTasksRegistry Current
        {
            get { return instance; }
        }

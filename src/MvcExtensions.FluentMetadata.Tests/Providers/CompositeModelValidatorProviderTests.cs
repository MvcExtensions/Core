...
namespace MvcExtensions.FluentMetadata.Tests
{
    ...
    public class CompositeModelValidatorProviderTests
    {
        ...
        private static System.Web.Mvc.ModelMetadata CreateModelMetadata()
        {
            Func<object> accessor = () => new object();

            return new Mock<System.Web.Mvc.ModelMetadata>(new Mock<ModelMetadataProvider>().Object, typeof(object), accessor, typeof(object), "foo").Object;
        }
    }
}
...
namespace MvcExtensions.FluentMetadata.Tests
{
    ...
    public class ExtendedModelValidatorProviderTests
    {
        ...
        public void GetValidators_should_return_empty_validators_when_metadata_is_not_extended_metadata()
        {
            ...
            var validators = provider.GetValidators(new Mock<System.Web.Mvc.ModelMetadata>(new Mock<ModelMetadataProvider>().Object, GetType(), accessor, typeof(DummyObject), null).Object, new ControllerContext());
